...
<td> <a href="deleteEmployee?requestAction=delete&emp_id=<%=employee.getEmp_id() %>">Delete</a> </td>
<td> <a href="updateEmployeeForm?requestAction=update&emp_id=<%=employee.getEmp_id() %>">Update</a> </td>
